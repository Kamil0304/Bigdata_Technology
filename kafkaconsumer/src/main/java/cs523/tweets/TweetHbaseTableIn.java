...
public class TweetHbaseTableIn {
	...
	static {
		try {
			...
			System.out.println("admin  : " + table.getTableName());
			...
			if (admin.tableExists(table.getTableName())) {
				...
				admin.deleteTable(table.getTableName());
				System.out.print("disabling and deleting table.... ");
			}
			admin.createTable(table);
			System.out.println("connection : " + connection.getTable(TableName.valueOf(TABLE_NAME)));
